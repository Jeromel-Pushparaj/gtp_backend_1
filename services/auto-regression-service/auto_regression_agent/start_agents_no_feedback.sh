...
# Start agents
echo "========================================="
echo "Starting Core Agents (No Feedback)..."
echo "========================================="
echo ""

echo -e "${BLUE}This will start 4 core AI agents:${NC}"
...
echo ""
echo -e "${YELLOW}Note: Feedback Agent is DISABLED (no vector DB needed)${NC}"
echo ""
...
# Run all agents (feedback agent will be created but won't crash)
