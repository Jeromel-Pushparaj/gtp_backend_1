...
func GetLevelsByPattern(pattern LevelPattern) []Level {
	...
	case PatternMetal:
		return []Level{
			{Name: "Bronze", DisplayName: "🥉 Bronze", OrderIndex: 1, Color: "#CD7F32", Icon: "🥉"},
			{Name: "Silver", DisplayName: "🥈 Silver", OrderIndex: 2, Color: "#C0C0C0", Icon: "🥈"},
			{Name: "Gold", DisplayName: "🥇 Gold", OrderIndex: 3, Color: "#FFD700", Icon: "🥇"},
		}
